...
Follow the active internal [Standard Bundle Authoring 2.7 workflow](../../standards/standard-bundle-authoring/versions/2.7/README.md#author-workflow). In summary:
