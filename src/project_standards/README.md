...
Follow the active internal [Standard Bundle Authoring 2.6 workflow](../../standards/standard-bundle-authoring/versions/2.6/README.md#author-workflow). In summary:
