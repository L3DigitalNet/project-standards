...
Follow the active internal [Standard Bundle Authoring 2.3 workflow](../../standards/standard-bundle-authoring/versions/2.3/README.md#author-workflow). In summary:
