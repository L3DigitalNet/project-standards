...
Follow the active internal [Standard Bundle Authoring 2.5 workflow](../../standards/standard-bundle-authoring/versions/2.5/README.md#author-workflow). In summary:
