...
def test_markdown_tooling_1_15__projection_and_catalog__stay_complete_and_unadvertised() -> None:
    source_files = {
    ...
    assert "1.15" not in advertised_versions
    assert (
        "| [`markdown-tooling`](markdown-tooling/README.md) | active | 1.15 | "
