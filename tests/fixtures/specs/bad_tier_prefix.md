...
Describe the existing implementation, workflow, or operating environment: R-001 is mentioned. systems involved, known limitations, relevant prior decisions, operational constraints, known failure modes.
