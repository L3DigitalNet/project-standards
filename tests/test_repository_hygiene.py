...
_POST_ANCHOR_IMMUTABLE_PROJECTION_EXECUTABLES = frozenset(
    {
        ...
        "standards/agent-handoff/versions/1.13/hooks/session-start/session-start",
        "standards/agent-handoff/versions/1.14/hooks/session-start/session-start",
        "standards/agent-handoff/versions/1.15/hooks/session-start/session-start",
        "standards/agent-handoff/versions/1.16/hooks/session-start/session-start",
        "standards/agent-handoff/versions/1.17/hooks/session-start/session-start",
        ...
        "standards/github-workflow/versions/1.7/skills/github-workflow/bin/gh-workflow",
        "standards/github-workflow/versions/1.8/skills/github-workflow/bin/gh-workflow",
        "standards/github-workflow/versions/1.9/skills/github-workflow/bin/gh-workflow",
        "standards/github-workflow/versions/1.10/skills/github-workflow/bin/gh-workflow",
        ...
        "standards/markdown-frontmatter/versions/1.15/skills/markdown-frontmatter/scripts/new-doc-id",
