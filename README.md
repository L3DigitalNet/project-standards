...
- **Standard:** [`standards/markdown-frontmatter/versions/1.11/README.md`](standards/markdown-frontmatter/versions/1.11/README.md)
- **Structure:** [`structure.md`](standards/markdown-frontmatter/versions/1.11/structure.md) · **Field values:** [`field-values.md`](standards/markdown-frontmatter/versions/1.11/field-values.md)
- **Schema:** [`schemas/markdown-frontmatter.schema.json`](standards/markdown-frontmatter/versions/1.11/schemas/markdown-frontmatter.schema.json) (JSON Schema Draft 2020-12)
- **Skill:** [`skills/markdown-frontmatter/`](standards/markdown-frontmatter/versions/1.11/skills/markdown-frontmatter/) — installed repo-local at `.agents/skills/markdown-frontmatter` for Claude Code and Codex CLI.
- **Templates:** [`templates/`](standards/markdown-frontmatter/versions/1.11/templates/) · **Examples:** [`examples/`](standards/markdown-frontmatter/versions/1.11/examples/) · **Adopt:** [`adopt.md`](standards/markdown-frontmatter/versions/1.11/adopt.md)

The standard defines **eleven required fields** plus a recommended optional set. Copy a ready-made block from [`templates/`](standards/markdown-frontmatter/versions/1.11/templates/) (`frontmatter-minimal.yml` or `frontmatter-standard.yml`); the [structure guide](standards/markdown-frontmatter/versions/1.11/structure.md) gives the hard field and controlled-value contract, and the [field-values guide](standards/markdown-frontmatter/versions/1.11/field-values.md) explains ownership, lifecycle, tags, aliases, relationships, and repo-local extensions.
...
- **Standard:** [`standards/agent-handoff/versions/1.12/README.md`](standards/agent-handoff/versions/1.12/README.md)
- **Skill:** [`skills/agent-handoff/`](standards/agent-handoff/versions/1.12/skills/agent-handoff/) — installed repo-local at `.agents/skills/agent-handoff/`.
- **Adopt:** [`adopt.md`](standards/agent-handoff/versions/1.12/adopt.md) · **Migration:** [`resources/legacy-migration.md`](standards/agent-handoff/versions/1.12/resources/legacy-migration.md)
...
- **Standard:** [`standards/github-workflow/versions/1.2/README.md`](standards/github-workflow/versions/1.2/README.md)
- **Skill:** [`skills/github-workflow/`](standards/github-workflow/versions/1.2/skills/github-workflow/) — installed repo-local at `.agents/skills/github-workflow/`, with the tool at `bin/gh-workflow`.
- **Adopt:** [`adopt.md`](standards/github-workflow/versions/1.2/adopt.md)
...
| --- | --- | --- |
| Markdown Frontmatter | `1.11` | [`standards/markdown-frontmatter/versions/1.11/adopt.md`](standards/markdown-frontmatter/versions/1.11/adopt.md) |
...
| Agent Handoff | `1.12` | [`standards/agent-handoff/versions/1.12/adopt.md`](standards/agent-handoff/versions/1.12/adopt.md) |
| GitHub Workflow | `1.2` | [`standards/github-workflow/versions/1.2/adopt.md`](standards/github-workflow/versions/1.2/adopt.md) |
