...
| ADR | Architecture Decision Records (MADR on the frontmatter profile) | 1.5 | default | [adr/](adr/) | [adopt](adr/adopt.md) |
| Python Tooling SSOT | Python stack, layout, CI gate, and agent instructions | 1.13 | default | [python-tooling/](python-tooling/) | [adopt](python-tooling/adopt.md) |
...
| Agent Handoff | Repository-local project knowledge, bounded session continuity, repo-local skill and hooks, and conformance tooling | 1.11 | default | [agent-handoff/](agent-handoff/) | [adopt](agent-handoff/adopt.md) |
| GitHub Workflow | GitHub work discipline for organization-owned repositories: typed issue contracts, PR evidence, an agent skill, and the `gh-workflow` tool | 1.1 | default | [github-workflow/](github-workflow/) | [adopt](github-workflow/adopt.md) |
