...
| Python Tooling SSOT | Python stack, layout, CI gate, and agent instructions | 1.2 | default | [python-tooling/](python-tooling/) | [adopt](python-tooling/adopt.md) |
| Markdown Tooling | Markdown/structured-text linting + formatting (markdownlint, Prettier, EditorConfig) | 1.3 | default | [markdown-tooling/](markdown-tooling/) | [adopt](markdown-tooling/adopt.md) |
...
| CLI Documentation | User-facing CLI usage docs: help text, usage references, man pages, CI drift checks | 1.2 | default | [cli-documentation/](cli-documentation/) | [adopt](cli-documentation/adopt.md) |
