...
The canonical [Markdown Frontmatter 1.10 standard](https://github.com/L3DigitalNet/project-standards/blob/v5.17.0/standards/markdown-frontmatter/versions/1.10/README.md) is authoritative and wins if this summary conflicts with it.

Lifecycle: active. Package: `markdown-frontmatter@1.10`.
...
Use the [versioned package documentation](https://github.com/L3DigitalNet/project-standards/tree/v5.17.0/standards/markdown-frontmatter/versions/1.10) for complete requirements.
