...
Current authority is the Catalog 5 consumer payload [`markdown-frontmatter@1.7`](versions/1.7/agent-summary.md). Its [versioned standard](versions/1.7/README.md) wins over this mutable navigation summary.
...
Enable `markdown-frontmatter@1.7`, preview with `project-standards reconcile`, and apply only after reviewing the plan. See the [current adoption guide](adopt.md) for the complete procedure.
