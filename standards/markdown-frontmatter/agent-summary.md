...
Current authority is the Catalog 5 consumer payload [`markdown-frontmatter@1.6`](versions/1.6/agent-summary.md). Its [versioned standard](versions/1.6/README.md) wins over this mutable navigation summary.
...
Enable `markdown-frontmatter@1.6`, preview with `project-standards reconcile`, and apply only after reviewing the plan. See the [current adoption guide](adopt.md) for the complete procedure.
