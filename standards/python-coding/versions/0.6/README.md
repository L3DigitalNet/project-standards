...
- **Status:** Draft (package version 0.6) — in development, reference-only; not available for consumer adoption or validation
...
standards/python-coding/versions/0.6/README.md   # code-shape and behavior rules (this document, reference-only)
```
