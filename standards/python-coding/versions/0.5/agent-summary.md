...
This reference-only standard owns code shape and agent behavior. The companion Python Tooling standard owns the executable uv/Ruff/BasedPyright/pytest/coverage/pip-audit gate, repository scaffolds, CI, and adoption. The companion relation does not make this document an adoptable package.
