...
Current authority is the Catalog 5 consumer payload [`agent-handoff@1.13`](versions/1.13/agent-summary.md). Its [versioned standard](versions/1.13/README.md) and installed repo-local skill win over this mutable navigation summary.
