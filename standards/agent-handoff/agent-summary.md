...
Current authority is the Catalog 5 consumer payload [`agent-handoff@1.17`](versions/1.17/agent-summary.md). Its [versioned standard](versions/1.17/README.md) and installed repo-local skill win over this mutable navigation summary.
