...
Current authority is the Catalog 5 consumer payload [`agent-handoff@1.16`](versions/1.16/agent-summary.md). Its [versioned standard](versions/1.16/README.md) and installed repo-local skill win over this mutable navigation summary.
