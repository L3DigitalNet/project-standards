...
Current authority is the Catalog 5 consumer payload [`adr@1.3`](versions/1.3/agent-summary.md). Its [versioned standard](versions/1.3/README.md) wins over this mutable navigation summary.
...
- Package 1.3 creates only `docs/adr/adr.template.md`; it never replaces consumer ADRs.
...
Enable `adr@1.3`, preview with `project-standards reconcile`, and apply only after reviewing the plan. See the [current adoption guide](adopt.md) for the complete procedure.
