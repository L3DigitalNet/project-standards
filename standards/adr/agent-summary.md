...
Current authority is the Catalog 5 consumer payload [`adr@1.2`](versions/1.2/agent-summary.md). Its [versioned standard](versions/1.2/README.md) wins over this mutable navigation summary.
...
- Package 1.2 creates only `docs/adr/adr.template.md`; it never replaces consumer ADRs.
...
Enable `adr@1.2`, preview with `project-standards reconcile`, and apply only after reviewing the plan. See the [current adoption guide](adopt.md) for the complete procedure.
