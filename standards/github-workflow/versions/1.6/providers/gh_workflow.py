...
def _block_body(organization: str) -> str:
    ...
    return (
        ...
        "- A related finding you can address this session needs no issue: fix it in place "
        "when this repository owns it, file it against the owning upstream repository in "
        "the organization, and ask the operator whether to file or tackle it now only when "
        "it warrants a full separate session.\n"
        "\n"
