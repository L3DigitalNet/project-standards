...
This is the Catalog 5 family landing page for the consumer package `github-workflow@1.0`. The immutable versioned payload, not this mutable landing page, defines the selected standard.
...
```bash
project-standards standards enable github-workflow --version 1.0
project-standards reconcile
project-standards reconcile --apply
```

Both configuration options are required. Review [the 1.0 adoption guide](versions/1.0/adopt.md) before applying.
...
The family root is mutable navigation. The exact `versions/1.0/` payload is the current artifact; corrections to its normative content require a new package version rather than edits in place after publication.
