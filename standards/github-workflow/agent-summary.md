...
Current authority is the Catalog 5 consumer payload [`github-workflow@1.6`](versions/1.6/agent-summary.md). Its [versioned standard](versions/1.6/README.md) and installed repo-local skill win over this mutable navigation summary.
