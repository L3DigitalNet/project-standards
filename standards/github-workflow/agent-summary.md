...
Current authority is the Catalog 5 consumer payload [`github-workflow@1.0`](versions/1.0/agent-summary.md). Its [versioned standard](versions/1.0/README.md) and installed repo-local skill win over this mutable navigation summary.
...
- `audit`, `summary`, `receipt`, and `check` are reads. `ledger` writes `docs/GH-WORKFLOWS.md`, which the tool owns whole-file and regenerates; never hand-edit it.
