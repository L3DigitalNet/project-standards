...
Current authority is the Catalog 5 consumer payload [`github-workflow@1.4`](versions/1.4/agent-summary.md). Its [versioned standard](versions/1.4/README.md) and installed repo-local skill win over this mutable navigation summary.
