# Markdown Tooling 1.2: Agent Summary
...
The package manages `.prettierrc.json`, `.markdownlint.json`, and distinct lint/format caller workflows. It contributes only bounded EditorConfig properties, VS Code settings and extension entries, and managed Markdown instruction blocks. Preserve all unrelated consumer content.
