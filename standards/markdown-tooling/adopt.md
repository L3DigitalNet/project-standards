...
The current consumer package is [`markdown-tooling@1.14`](versions/1.14/adopt.md). Use it for markdownlint and Prettier configuration, managed lint/format workflows, and bounded EditorConfig, VS Code, and agent-instruction contributions.
