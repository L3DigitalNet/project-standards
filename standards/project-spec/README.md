...
This is the Catalog 5 family landing page for the active consumer package `project-spec@1.4`. The immutable versioned payload, not this mutable landing page, defines the selected standard.

## Current authority

- [Project Specification 1.4 standard](versions/1.4/README.md) — normative profiles, identifiers, traceability, and tooling contract
- [Project Specification 1.4 adoption guide](versions/1.4/adopt.md) — exact options, outputs, authoring operations, migration, and verification
- [Current family adoption guide](adopt.md) — concise enable/reconcile workflow
- [Project Specification 1.4 agent summary](versions/1.4/agent-summary.md) — compact operating rules
...
The immutable 1.1 README contains wording written before Catalog 5 and Project Standards v5.0.0 were published. Treat any statement that this payload is not released as release-time history. Catalog 5 now selects `project-spec@1.4`; the immutable 1.1 payload bytes remain unchanged.
