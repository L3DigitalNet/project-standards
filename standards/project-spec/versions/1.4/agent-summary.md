# Project Specification 1.4 summary

The canonical [README](README.md) is authoritative and wins if this summary conflicts with it.

- Package version `1.4`; independent document `contract_version` `1.1`; consumer availability.
- Enable with `project-standards standards enable project-spec --version 1.4`, review with `project-standards reconcile`, and apply with `project-standards reconcile --apply`.
