...
- [Spec Template Tooling Notes](#spec-template-tooling-notes)
  ...
  - [5. ID conventions](#5-id-conventions) - [5.1 Prefix registry (Appendix A — identical "Defined In" across all tiers)](#51-prefix-registry-appendix-a--identical-defined-in-across-all-tiers) - [5.2 Format](#52-format) - [5.3 Example IDs are placeholders](#53-example-ids-are-placeholders)
