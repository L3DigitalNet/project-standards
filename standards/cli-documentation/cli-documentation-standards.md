...
This template is intentionally conservative. It will convert cleanly into a man page or remain perfectly readable as Markdown. It also matches the structure your prior in-repo research recommended.

### Compact single-file README template

For single-file scripts, the documentation set should usually be compressed into one README plus `script --help`. Your current repository already uses that distribution style: executable scripts with direct `--help` invocation and no required installable package boundary.
...
Automation is where this framework becomes sustainable instead of aspirational. The parser should generate accepted syntax and most help text; the docs pipeline should generate or validate downstream artifacts; CI should prove that the surfaces still match after each change. That is exactly the problem space addressed by argparse, Click, Typer, help2man, argparse-manpage, sphinx-click, and sphinx-argparse.
...
- [`man-pages(7)`](https://man7.org/linux/man-pages/man7/man-pages.7.html) — man7.org
- [GNU Coding Standards, command-line interfaces](https://www.gnu.org/prep/standards/html_node/Command_002dLine-Interfaces.html) — gnu.org
- [Command Line Interface Guidelines](https://clig.dev/) — clig.dev
- [GitHub CLI command-line syntax guide](https://github.com/cli/cli/blob/trunk/docs/command-line-syntax.md) — github.com
- [`argparse`](https://docs.python.org/3/library/argparse.html) — docs.python.org
- [Click, documenting scripts](https://click.palletsprojects.com/en/stable/documentation/) — click.palletsprojects.com
- [Typer, command help](https://typer.tiangolo.com/tutorial/commands/help/) — typer.tiangolo.com
- [GNU `help2man`](https://www.gnu.org/software/help2man/) — gnu.org
- [GNU gettext manual](https://www.gnu.org/software/gettext/manual/gettext.html) — gnu.org
- [Sphinx internationalization](https://www.sphinx-doc.org/en/master/usage/advanced/intl.html) — sphinx-doc.org
- [WCAG 2.2](https://www.w3.org/TR/WCAG22/) — w3.org
- [`NO_COLOR`](https://no-color.org/) — no-color.org
- [`argparse-manpage`](https://github.com/praiskup/argparse-manpage) — github.com
- [`sphinx-click`](https://sphinx-click.readthedocs.io/en/latest/) — sphinx-click.readthedocs.io
- [`sphinx-argparse`](https://sphinx-argparse.readthedocs.io/en/latest/) — sphinx-argparse.readthedocs.io
- [Semantic Versioning](https://semver.org/) — semver.org
- [Keep a Changelog](https://keepachangelog.com/en/1.1.0/) — keepachangelog.com
