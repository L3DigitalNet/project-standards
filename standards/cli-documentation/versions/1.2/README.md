# CLI Documentation Standard 1.2

- **Status:** Active; immutable package version 1.2; documentation contract 1.0.
...
- [CLI Documentation Standard 1.2](#cli-documentation-standard-12)
