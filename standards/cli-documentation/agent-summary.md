...
Current authority is the Catalog 5 consumer payload [`cli-documentation@1.4`](versions/1.4/agent-summary.md). Its [versioned standard](versions/1.4/README.md) wins over this mutable navigation summary.

- Select the Script, Packaged, or Packaged-deep profile independently of package version 1.4.
...
- Package 1.4 owns only a create-only `docs/usage.md`; existing usage prose remains consumer-owned.
