...
Current authority is the Catalog 5 consumer payload [`cli-documentation@1.5`](versions/1.5/agent-summary.md). Its [versioned standard](versions/1.5/README.md) wins over this mutable navigation summary.

- Select the Script, Packaged, or Packaged-deep profile independently of package version 1.5.
...
- Package 1.5 owns only a create-only `docs/usage.md`; existing usage prose remains consumer-owned.
