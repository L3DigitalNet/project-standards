# Adopt Python Tooling 1.11

Python Tooling 1.11 is reconciled by the V5 control plane; do not copy payload files or merge a printed `pyproject.toml` fragment.
