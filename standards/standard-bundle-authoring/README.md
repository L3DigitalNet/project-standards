...
This is the Catalog 5 family landing page for the active internal package `standard-bundle-authoring@2.7`. Version 2.7 is the current authority for this repository; it is not staged and consumers cannot enable it. Versions 2.0, 2.1, 2.2, 2.3, 2.4, 2.5, and 2.6 remain advertised as released history.

## Current authority

- [Standard Bundle Authoring 2.7 standard](versions/2.7/README.md) — normative family, payload, catalog, provider, migration, and ownership contract
- [Standard Bundle Authoring 2.7 agent summary](versions/2.7/agent-summary.md) — compact authoring rules
- [Versioned templates](versions/2.7/templates/) — canonical package-authoring templates
...
Use version 2.7 when authoring or reviewing package families, immutable payloads, catalog declarations, closed option schemas, resources, semantic contributions, providers, migrations, compatibility evidence, or release-level classification in this repository.

The package is `internal`: it declares no consumer outputs or executable providers and has no adoption guide. Follow the [versioned author workflow](versions/2.7/README.md#author-workflow) and start from the [versioned templates](versions/2.7/templates/).
