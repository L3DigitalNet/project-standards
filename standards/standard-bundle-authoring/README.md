...
This is the Catalog 5 family landing page for the active internal package `standard-bundle-authoring@2.6`. Version 2.6 is the current authority for this repository; it is not staged and consumers cannot enable it. Versions 2.0, 2.1, 2.2, 2.3, 2.4, and 2.5 remain advertised as released history.

## Current authority

- [Standard Bundle Authoring 2.6 standard](versions/2.6/README.md) — normative family, payload, catalog, provider, migration, and ownership contract
- [Standard Bundle Authoring 2.6 agent summary](versions/2.6/agent-summary.md) — compact authoring rules
- [Versioned templates](versions/2.6/templates/) — canonical package-authoring templates
...
Use version 2.6 when authoring or reviewing package families, immutable payloads, catalog declarations, closed option schemas, resources, semantic contributions, providers, migrations, compatibility evidence, or release-level classification in this repository.
