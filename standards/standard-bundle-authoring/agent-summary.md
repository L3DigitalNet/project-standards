...
Current authority is the active Catalog 5 internal payload [`standard-bundle-authoring@2.2`](versions/2.2/agent-summary.md). Its [versioned standard](versions/2.2/README.md) wins over this mutable navigation summary.
...
Version 2.2 is active and internal, not staged or consumer-selectable; versions 2.0 and 2.1 stay advertised as released history. Use the [author workflow](versions/2.2/README.md#author-workflow) and [templates](versions/2.2/templates/).
