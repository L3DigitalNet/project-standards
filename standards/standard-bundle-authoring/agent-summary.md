...
Current authority is the active Catalog 5 internal payload [`standard-bundle-authoring@2.3`](versions/2.3/agent-summary.md). Its [versioned standard](versions/2.3/README.md) wins over this mutable navigation summary.
...
Version 2.3 is active and internal, not staged or consumer-selectable; versions 2.0, 2.1, and 2.2 stay advertised as released history. Use the [author workflow](versions/2.3/README.md#author-workflow) and [templates](versions/2.3/templates/).
