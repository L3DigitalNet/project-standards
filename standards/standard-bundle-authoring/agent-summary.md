...
Current authority is the active Catalog 5 internal payload [`standard-bundle-authoring@2.5`](versions/2.5/agent-summary.md). Its [versioned standard](versions/2.5/README.md) wins over this mutable navigation summary.
...
Version 2.5 is active and internal, not staged or consumer-selectable; versions 2.0, 2.1, 2.2, 2.3, and 2.4 stay advertised as released history. Use the [author workflow](versions/2.5/README.md#author-workflow) and [templates](versions/2.5/templates/).
