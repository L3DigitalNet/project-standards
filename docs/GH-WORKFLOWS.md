...
Generated by `gh-workflow` 1.1 · 3 open issues · 0 open PRs
...
| #170 | Bug | Packaged skills are undiscoverable by Claude Code: install skill copies to both .agents/skills and .claude/skills | Ready | P1 Next | S1 High | Interactive agent |
