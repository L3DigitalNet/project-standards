...
| 2026-07-09 | [Agent Handoff Standard Package — SPEC-DPEY](2026-07-09-agent-handoff-standard-package.md) | draft (Full spec; awaiting owner review) | Ingest `agent-handoff` as a v1 CLI-backed standard package with repository-only ownership, Claude Code/Codex SessionStart profiles, agent-guided legacy migration, and retirement gates for the old repository |
