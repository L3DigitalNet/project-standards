...
- [ ] Complete the Consumer Standards Control Plane (`SPEC-CP01`) follow-on for v5.
  ...
  The 18-task follow-on plan is drafted at `docs/superpowers/plans/2026-07-11-consumer-standards-control-plane-package-migration-release.md`. Rounds 1-2 are remediated; scratch-path convergence re-audit and owner approval remain before execution.
