...
- [ ] Complete the reviewed MCP implementation plan.
  ...
  - [ ] Finish T8 (catalog and repository inspection tools): RED and Verify RED are complete; rerun the Codex RED review (the 2026-07-29 session halted on /tmp inode exhaustion), then GREEN through commit.
