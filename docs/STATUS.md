...
- CP01 follow-on Tasks 1-6 are complete: migration/apply, catalog refresh/recovery, Authoring 2.0 self-hosting, and Python Coding 0.5 reconstruction. Root V1 remains until Task 14.
