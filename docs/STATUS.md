...
- The approved CP01 follow-on is executing on `feature/v5-package-migration`; Tasks 1-3 cover typed reports, deterministic planning, and transactional migration apply/recovery.
