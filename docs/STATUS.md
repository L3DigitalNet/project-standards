...
- CP01 follow-on Tasks 1-8 are complete: migration/apply, catalog refresh/recovery, Authoring 2.0 self-hosting, Python Coding 0.5, Markdown Frontmatter 1.2, and ADR 1.1 reconstruction. The package-contract gate passes 351 tests; root V1 remains until Task 14.
