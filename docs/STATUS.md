...
- Agent Handoff v1 package and dogfood adoption are integrated on `testing` at `93296d6`; the 1,368-test acceptance gate and four installed-wheel probes pass.
