...
- The approved CP01 follow-on is executing on `feature/v5-package-migration`; Tasks 1-2 define typed reports and deterministic read-only migration planning.
