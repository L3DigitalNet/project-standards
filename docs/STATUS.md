...
- CP01 follow-on Tasks 1-9 are complete: migration/apply, catalog refresh/recovery, Authoring 2.0 self-hosting, Python Coding 0.5, Markdown Frontmatter 1.2, ADR 1.1, and CLI Documentation 1.1 reconstruction. The package-contract/control-plane gate passes 788 tests; root V1 remains until Task 14.
