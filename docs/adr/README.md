...
related:
  ...
  - 'docs/adr/adr-0031-integration-branch-admission-model.md'
---
...
| [0030](adr-0030-command-provider-execution-boundary.md) | Command Provider Execution Boundary | local | active |
| [0031](adr-0031-integration-branch-admission-model.md) | Integration-Branch Admission Model and Its Enforcement | local | review |
