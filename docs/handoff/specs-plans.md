...
| SPEC-MT01 Step 05 — Existing-standard manifest retrofit (plan) | `docs/superpowers/plans/2026-07-09-retrofit-standard-manifests.md` | **implemented 2026-07-09** (`82d1978`) — all eight `standards/*` bundles now ship graph-validated `standard.toml` manifests with authorities/resources/providers/relationships; `reference-only` standards no longer require an `adopt` resource. Step 06 remains dogfood fixtures + generated standards index/catalog |
