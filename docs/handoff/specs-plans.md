...
| SPEC-MT01 Step 01 — ADR foundation | `docs/adr/` (`adr-0001`…`adr-0013` + `README.md` index) | **done 2026-07-07** — 13 meta-repo readiness ADRs authored as **proposed** (`status: review`); `docs/adr/**` dogfood-wired into frontmatter/id/section validation. Owner to accept (review→active). SPEC-MS01 server ADRs deferred to the server phase |
