...
| SPEC-MT01 Step 02 — Standard Bundle Authoring (design) | `docs/superpowers/specs/2026-07-07-standard-bundle-authoring-standard.md` (**SPEC-BA01**, Light) | **design written 2026-07-07, awaiting owner spec-review** — the meta-standard's contract, brainstormed then scaffolded via `spec new` as a Light project spec (dogfoods the Project Specification Standard). Internal/reference; doc-only (schema deferred to Step 03). Next: owner review → writing-plans → author the standard |
