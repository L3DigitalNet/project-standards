...
| project-spec tooling Spec #2 plan (`new` scaffold) | `docs/superpowers/plans/2026-07-04-project-spec-tooling-spec2.md` | written (7 tasks, TDD); awaiting codex plan-review before implementation |
