...
| SPEC-MT01 Step 02 — Standard Bundle Authoring (design) | `docs/superpowers/specs/2026-07-07-standard-bundle-authoring-standard.md` (**SPEC-BA01**, Light, rev 0.3) | **design written + Codex-converged (r2) 2026-07-07; awaiting owner spec-review** — the meta-standard's contract, brainstormed then scaffolded via `spec new` (dogfoods the Project Specification Standard); Codex audits in `docs/codex-reviews/`. Internal/reference; doc-only (schema deferred to Step 03). Next: owner review → writing-plans → author the standard |
