...
| Item | Path | Status |
| --- | --- | --- |
| Frontmatter suite (format/references/fix) design | `docs/superpowers/specs/2026-06-08-frontmatter-suite-design.md` | draft (brainstorming complete; awaiting user + codex spec-review) |
