...
- Unreleased work is complete on `testing` (1.3.0 lint/format + Python Tooling SSOT + standards restructure + per-standard versioning + Markdown Tooling Standard); release ritual deliberately deferred. `main` holds releases; moving `v1` tracks newest. Delta: `git log main..testing`.
