...
- **`3.0.0` RELEASED on `main` 2026-06-12** (tags `v3.0.0`+`v3`; `v2` frozen at `3ece2c9`; GitHub release live). `testing` is now ~50 commits ahead of `main` with the unreleased validator fixes.

## Active incidents

- _None._ Full gate green: 509 tests, 93% cov, basedpyright 0/0/0, prettier/markdownlint/dogfood clean.
