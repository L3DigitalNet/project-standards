...
```text
project-standards
├── standards/          -> governing standards, one bundle each (markdown-frontmatter, adr, python-tooling, markdown-tooling, project-spec, cli-documentation) + python-coding (draft, reference-only, unregistered) + README index
