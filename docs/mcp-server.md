...
```bash
uv tool install "git+https://github.com/L3DigitalNet/project-standards@v5.20.0"
```
...
sha256sum dist/project_standards-5.20.0-py3-none-any.whl
uv tool install ./dist/project_standards-5.20.0-py3-none-any.whl
```
