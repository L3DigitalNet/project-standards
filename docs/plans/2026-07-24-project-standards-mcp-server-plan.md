...
size: full
status: active
source: 'SPEC-MS01 revision 1.1 and SPEC-RD01 revision 1.3'
...
- **preconditions:** approved `SPEC-RD01` 1.3 and `SPEC-MS01` 1.1; final 2026-07-28 protocol publication and official SDK release evidence are available; no `src/project_standards/mcp_*` implementation exists.
