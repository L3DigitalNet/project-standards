...
| [SPEC-VFCT — V5 Validation Fidelity Correction Train](2026-07-27-v5-validation-fidelity-correction-train-spec.md) | draft rev 0.2; pending owner review | Issues #50-#69: shared spec-engine, `standards show`, and control-plane planning loosening fixes (including #66's create-only removal guard), four new successor payloads, and the Catalog 5 default advance toward v5.10.0 |
