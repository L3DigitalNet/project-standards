...
| [SPEC-MS01 — MCP Server Implementation](2026-07-07-project-standards-mcp-server-implementation-spec.md) | approved and locked rev 1.4; T1 decision gate closed 2026-07-28; `OQ-005` resolved 2026-07-30 at the T11 client/documentation gate | SDK-independent services plus thin local read-only stdio adapter; boundary and transport decisions recorded in ADR 0025 and ADR 0026 |
