...
| --- | --- | --- |
| [SPEC-MT01 — Meta-Repository MCP Readiness](2026-07-07-project-standards-meta-repo-mcp-readiness-spec.md) | approved rev 1.1; complete | Historical Step 07 contract plus current 5.8.0 successor-state reconciliation |
| [SPEC-RD01 — MCP Enablement Roadmap](2026-07-07-project-standards-mcp-enablement-roadmap-spec.md) | approved and locked rev 1.1; Opus review converged | Step 08 documentation gate and Step 09-through-18 sequencing |
| [SPEC-MS01 — MCP Server Implementation](2026-07-07-project-standards-mcp-server-implementation-spec.md) | approved and locked rev 0.9; Opus review converged | SDK-independent services plus thin local read-only stdio adapter; implementation not started |
