...
| [SPEC-DPEY — Agent Handoff Standard Package](2026-07-09-agent-handoff-standard-package.md) | approved rev 0.9; released package `1.7`; verified `1.8` candidate pending release preparation; retirement pending | V1 baseline plus Catalog 5 precedence, the adaptive SessionStart launcher successor, and Task 18 retirement gates |
