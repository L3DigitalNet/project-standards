...
| 2026-07-22 | [V5 Managed-Edit Fidelity Correction Train](2026-07-22-v5-managed-edit-fidelity-correction-train-design.md) | in implementation (targets 5.7.0) | Python Tooling 1.7 per-root coverage scoping for `additional_source_roots` and anchored TOML managed-region comment preservation (issues #24–#25) |
