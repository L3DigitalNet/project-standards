...
| 2026-06-08 | [Frontmatter Validation + Autocorrection Suite](2026-06-08-frontmatter-suite-design.md) | implemented | The `format-frontmatter` autoformatter and `validate-references` semantic validators, with the locked consumer contract for both |
...
| 2026-07-21 | [Upgrade Compatibility Fixes](2026-07-21-upgrade-compatibility-fixes-design.md) | released (5.4.0) | Python Tooling 1.5 narrowed checker/pytest table ownership and Markdown Tooling 1.6 inline-code glob rendering, unblocking consumer upgrades (issues #14-#15) |
...
| 2026-07-22 | [V5 Adoption Friction Correction Train](2026-07-22-v5-adoption-friction-correction-train-design.md) | released (5.8.0) | Python Tooling 1.8 `pytest.test_paths`, Markdown Tooling 1.8 legacy byte-form acceptance, Markdown Frontmatter 1.5 `workflow_ownership`, minimal-escape frontmatter serialization on the pinned Prettier oracle, conflict first-difference pointers, and CLI/legacy-note hardening (issues #26–#31) |
| 2026-08-06 | [GitHub Repository Administration Standard (preliminary)](2026-08-06-github-repo-administration-preliminary-design.md) | superseded as design input by the approved `github-workflow` package design | Advice-style operating model for GitHub as the durable control plane: five Issue Types, seven organization Issue Fields, lifecycle, invariants INV-001–016, and the six-phase adoption sequence consumed by `docs/specs/2026-08-06-github-workflow-package-design.md` |
