...
| 2026-07-22 | [V5 Migration Correction Train](2026-07-22-v5-migration-correction-train-design.md) | owner-authorized; implementation pending | Versioned corrections for semantic V4 workflow migration, empty Project Spec corpora, and consumer-only Agent Handoff size budgets |
