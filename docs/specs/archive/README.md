...
| 2026-07-22 | [V5 Upgrade Usability Correction Train](2026-07-22-v5-upgrade-usability-correction-train-design.md) | owner-authorized; implementation pending | Python Tooling 1.6 additional source roots, enriched conflict diagnostics with governing-option pointers, migration preview exit-code contract, and upgrade-doc corrections (issues #20–#23) |
