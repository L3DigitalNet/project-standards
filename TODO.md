...
- [x] **Step 05 — Retrofit** every existing standard with a manifest, authorities, and resources. — done 2026-07-09 (`82d1978`): added `standard.toml` manifests for all eight standard bundles (including `python-coding` as `reference-only`) plus current-repo graph enforcement under `--require-all-manifests`.
