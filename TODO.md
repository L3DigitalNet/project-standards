...
- [x] **Step 03 — `standard.toml` manifest** schema/model + valid/invalid fixtures. — done 2026-07-08 (commits 89464ea..95977f8, subagent-driven; pydantic runtime dep added).
