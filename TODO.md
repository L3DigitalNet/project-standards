...
- [x] **Delete `scripts/validate_id.py`** — DONE 2026-06-12 (user-approved). The stale pre-`id_format` snapshot is removed; `scripts/README.md` updated. The pyz build was never affected (it bundles the package source).
