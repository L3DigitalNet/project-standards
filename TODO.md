...
- [ ] **Project-spec follow-on after Spec #1 tooling:** write README §6 Adoption and decide/register the `project-spec` standard once the local Spec #1 implementation is committed/released. `new`/`upgrade` authoring commands remain deferred to Spec #2.
