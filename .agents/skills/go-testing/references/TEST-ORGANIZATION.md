...
**Local variables**: Prefix test double variables with the double type for clarity at the call site:
...
This scopes the database lifecycle to the subtests that need it. Use `TestMain` only as a last resort (see [INTEGRATION.md](INTEGRATION.md)).
