...
The `atomic.Bool`, `atomic.Int64`, etc. types (available in stdlib `sync/atomic` since Go 1.19, or via [go.uber.org/atomic](https://pkg.go.dev/go.uber.org/atomic)) add type safety by hiding the underlying type.
