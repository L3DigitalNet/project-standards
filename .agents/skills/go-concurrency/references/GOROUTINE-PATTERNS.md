...
> The `sync.WaitGroup` pattern for multiple goroutines is in the parent skill (SKILL.md § Goroutine Lifetimes). Below is the done-channel alternative for a single goroutine.
