...
metadata:
  github-path: skills/go-defensive
  github-ref: refs/heads/main
  github-repo: https://github.com/cxuu/golang-skills
  github-tree-sha: 397c9e3184fbe5f8bbef3706e54e043ac5272a68
name: go-defensive
---
...
Route compile-time interface assertions to [go-interfaces](../go-interfaces/SKILL.md). Use this skill only to notice API-boundary robustness risk; the interface skill owns when an assertion is appropriate and the exact assertion shape.
