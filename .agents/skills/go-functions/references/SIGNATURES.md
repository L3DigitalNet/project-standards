...
Use grouping when the parameter names make the roles obvious; use separate declarations when they don't.
...
See [go-naming](../../go-naming/SKILL.md) for receiver naming conventions (short, one or two letter abbreviations).
