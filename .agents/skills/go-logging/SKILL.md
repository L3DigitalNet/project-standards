...
metadata:
  github-path: skills/go-logging
  github-ref: refs/heads/main
  github-repo: https://github.com/cxuu/golang-skills
  github-tree-sha: 0d6472a7259bcf277423c70ace8e14756131c6fc
name: go-logging
---
...
The handle-once rule belongs to [go-error-handling](../go-error-handling/SKILL.md). In logging work, apply it by choosing either a local log-and-recover path or a return path with context, not both for the same error.
...
See [go-error-handling](../go-error-handling/SKILL.md) for the full handle-once pattern and error wrapping guidance.
