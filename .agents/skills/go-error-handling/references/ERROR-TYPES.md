...
> The error-type decision table is in the parent skill (SKILL.md § Error Types). This reference covers: expanded code examples, sentinel errors, error checking with `errors.Is`/`errors.As`, and structured error types.
