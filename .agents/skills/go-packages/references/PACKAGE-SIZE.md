...
Detailed guidance on package splitting, avoiding init(), the run() pattern, and CLI structure.
...
No "one type, one file" convention in Go. Files should be focused enough to know which file contains something and small enough to find things easily.
