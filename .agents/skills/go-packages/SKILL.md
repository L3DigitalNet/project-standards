...
metadata:
  github-path: skills/go-packages
  github-ref: refs/heads/main
  github-repo: https://github.com/cxuu/golang-skills
  github-tree-sha: 29c86b9d86455e72e2da8bd84047fe260ca5fa7b
name: go-packages
---
...
Generic names can be used as _part_ of a name (e.g., `stringutil`) but should not be the entire package name.
...
Imports are organized in groups separated by blank lines. Standard library packages always come first. Use [goimports](https://pkg.go.dev/golang.org/x/tools/cmd/goimports) to manage this automatically.
